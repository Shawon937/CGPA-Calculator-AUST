...
public class EEETwoTwo extends AppCompatActivity {

    public static String strMarkEEE22;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eeetwo_two);
    }

    public void EEE22(View v) {
        try {

            EditText EEEzero = (EditText) findViewById(R.id.EEE22IDread);

            EditText EEEses = (EditText) findViewById(R.id.EEE22Session);
            String EEESES=EEEses.getText().toString();


            EditText EEEone = (EditText) findViewById(R.id.EEE2203read);
            EditText EEEtwo = (EditText) findViewById(R.id.EEE2204read);
            EditText EEEthree = (EditText) findViewById(R.id.EEE2205read);
            EditText EEEfour = (EditText) findViewById(R.id.EEE2206read);
            EditText EEEfive = (EditText) findViewById(R.id.EEE2210read);
            EditText EEEsix = (EditText) findViewById(R.id.EEE2211read);
            EditText EEEseven = (EditText) findViewById(R.id.EEE2212read);
            EditText EEEeight = (EditText) findViewById(R.id.EEEMath2203read);
            EditText EEEnine = (EditText) findViewById(R.id.EEEHum2209read);
            ...
            Intent intent = new Intent(EEETwoTwo.this, GpaEEE22.class);
            intent.putExtra(strMarkEEE22, pass);
