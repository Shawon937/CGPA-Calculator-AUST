...
public class METwoOne extends AppCompatActivity {

    public static String strMarkME21;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_metwo_one);
    }

    public void ME21(View v) {
        try {

            EditText MEzero = (EditText) findViewById(R.id.ME21IDread);

            EditText MEses = (EditText) findViewById(R.id.ME21Session);
            String MESES=MEses.getText().toString();


            EditText MEone = (EditText) findViewById(R.id.MEIPE2101read);
            EditText MEtwo = (EditText) findViewById(R.id.ME2101read);
            EditText MEthree = (EditText) findViewById(R.id.MEMath2107read);
            EditText MEfour = (EditText) findViewById(R.id.MEEEE2187read);
            EditText MEfive = (EditText) findViewById(R.id.MEHum2107read);
            EditText MEsix = (EditText) findViewById(R.id.ME2102read);
            EditText MEseven = (EditText) findViewById(R.id.MEIPE2102read);
            EditText MEeight = (EditText) findViewById(R.id.MEEEE2188read);
            ...
            Intent intent = new Intent(METwoOne.this, GpaME21.class);
            intent.putExtra(strMarkME21, pass);
