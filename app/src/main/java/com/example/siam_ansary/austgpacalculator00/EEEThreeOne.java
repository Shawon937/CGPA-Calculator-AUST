...
public class EEEThreeOne extends AppCompatActivity {

    public static String strMarkEEE31;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eeethree_one);
    }

    public void EEE31(View v) {
        try {

            EditText EEEzero = (EditText) findViewById(R.id.EEE31IDread);

            EditText EEEses = (EditText) findViewById(R.id.EEE31Session);
            String EEESES=EEEses.getText().toString();


            EditText EEEone = (EditText) findViewById(R.id.EEE3103read);
            EditText EEEtwo = (EditText) findViewById(R.id.EEE3104read);
            EditText EEEthree = (EditText) findViewById(R.id.EEE3107read);
            EditText EEEfour = (EditText) findViewById(R.id.EEE3110read);
            EditText EEEfive = (EditText) findViewById(R.id.EEE3113read);
            EditText EEEsix = (EditText) findViewById(R.id.EEE3100read);
            EditText EEEseven = (EditText) findViewById(R.id.EEE3117read);
            EditText EEEeight = (EditText) findViewById(R.id.EEEHum3109read);
            ...
            Intent intent = new Intent(EEEThreeOne.this, GpaEEE31.class);
            intent.putExtra(strMarkEEE31, pass);
