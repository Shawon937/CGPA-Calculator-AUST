...
public class CSEThreeOne extends AppCompatActivity {

    public static String strMarkCSE31;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_csethree_one);
    }

    public void CSE31(View v) {
        try {

            EditText CSEzero = (EditText) findViewById(R.id.CSE31IDread);

            EditText CSEses = (EditText) findViewById(R.id.CSE31Session);
            String CSESES = CSEses.getText().toString();


            EditText CSEone = (EditText) findViewById(R.id.CSEHum3115read);
            EditText CSEtwo = (EditText) findViewById(R.id.CSE3100read);
            EditText CSEthree = (EditText) findViewById(R.id.CSE3101read);
            EditText CSEfour = (EditText) findViewById(R.id.CSE3103read);
            EditText CSEfive = (EditText) findViewById(R.id.CSE3104read);
            EditText CSEsix = (EditText) findViewById(R.id.CSE3107read);
            EditText CSEseven = (EditText) findViewById(R.id.CSE3108read);
            EditText CSEeight = (EditText) findViewById(R.id.CSE3109read);
            EditText CSEnine = (EditText) findViewById(R.id.CSE3110read);
            ...
            Intent intent = new Intent(CSEThreeOne.this, GpaCSE31.class);
            intent.putExtra(strMarkCSE31, pass);
