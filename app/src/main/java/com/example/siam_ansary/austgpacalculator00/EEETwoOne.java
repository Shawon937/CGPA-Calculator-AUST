...
public class EEETwoOne extends AppCompatActivity {

    public static String strMarkEEE21;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eeetwo_one);
    }

    public void EEE21(View v) {
        try {

            EditText EEEzero = (EditText) findViewById(R.id.EEE21IDread);

            EditText EEEses = (EditText) findViewById(R.id.EEE21Session);
            String EEESES=EEEses.getText().toString();


            EditText EEEone = (EditText) findViewById(R.id.EEE2103read);
            EditText EEEtwo = (EditText) findViewById(R.id.EEE2104read);
            EditText EEEthree = (EditText) findViewById(R.id.EEE2105read);
            EditText EEEfour = (EditText) findViewById(R.id.EEE2106read);
            EditText EEEfive = (EditText) findViewById(R.id.EEE2109read);
            EditText EEEsix = (EditText) findViewById(R.id.EEE2110read);
            EditText EEEseven = (EditText) findViewById(R.id.EEEMath2103read);
            EditText EEEeight = (EditText) findViewById(R.id.EEEHum2109read);
            EditText EEEnine = (EditText) findViewById(R.id.EEEHum2110read);
            ...
            Intent intent = new Intent(EEETwoOne.this, GpaEEE21.class);
            intent.putExtra(strMarkEEE21, pass);
