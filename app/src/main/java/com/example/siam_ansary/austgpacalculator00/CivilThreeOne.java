...
public class CivilThreeOne extends AppCompatActivity {

    public static String strMarkCivil31;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_civil_three_one);
    }

    public void Civil31(View v) {
        try {

            EditText Civilzero = (EditText) findViewById(R.id.Civil31IDread);

            EditText Civilses = (EditText) findViewById(R.id.Civil31Session);
            String CivilSES = Civilses.getText().toString();


            EditText Civilone = (EditText) findViewById(R.id.Civil311read);
            EditText Civiltwo = (EditText) findViewById(R.id.Civil315read);
            EditText Civilthree = (EditText) findViewById(R.id.Civil331read);
            EditText Civilfour = (EditText) findViewById(R.id.Civil341read);
            EditText Civilfive = (EditText) findViewById(R.id.Civil351read);
            EditText Civilsix = (EditText) findViewById(R.id.Civil371read);
            EditText Civilseven = (EditText) findViewById(R.id.Civil312read);
            EditText Civileight = (EditText) findViewById(R.id.Civil332read);
            EditText Civilnine = (EditText) findViewById(R.id.Civil344read);
            ...
            Intent intent = new Intent(CivilThreeOne.this, GpaCivil31.class);
            intent.putExtra(strMarkCivil31, pass);
