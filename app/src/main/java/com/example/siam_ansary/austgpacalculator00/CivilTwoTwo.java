...
public class CivilTwoTwo extends AppCompatActivity {

    public static String strMarkCivil22;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_civil_two_two);
    }

    public void Civil22(View v) {
        try {

            EditText Civilzero = (EditText) findViewById(R.id.Civil22IDread);

            EditText Civilses = (EditText) findViewById(R.id.Civil22Session);
            String CivilSES=Civilses.getText().toString();


            EditText Civilone = (EditText) findViewById(R.id.CivilCE203read);
            EditText Civiltwo = (EditText) findViewById(R.id.CivilCE213read);
            EditText Civilthree = (EditText) findViewById(R.id.CivilCE271read);
            EditText Civilfour = (EditText) findViewById(R.id.CivilMath233read);
            EditText Civilfive = (EditText) findViewById(R.id.CivilHum203read);
            EditText Civilsix = (EditText) findViewById(R.id.CivilCE200read);
            EditText Civilseven = (EditText) findViewById(R.id.CivilCE208read);
            EditText Civileight = (EditText) findViewById(R.id.CivilCE272read);
            EditText Civilnine = (EditText) findViewById(R.id.CivilCE104read);
            ...
            double res = gradeCheck(CivilONE) * 3.0 + gradeCheck(CivilTWO) * 3.0 +
                    ...
                    gradeCheck(CivilFIVE) * 2.0 + gradeCheck(CivilSIX) * 1.5 +
            ...
            Intent intent = new Intent(CivilTwoTwo.this, GpaCivil22.class);
            intent.putExtra(strMarkCivil22, pass);
