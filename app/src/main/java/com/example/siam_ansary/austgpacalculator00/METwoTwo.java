...
public class METwoTwo extends AppCompatActivity {

    public static String strMarkME22;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_metwo_two);
    }

    public void ME22(View v) {
        try {

            EditText MEzero = (EditText) findViewById(R.id.ME22IDread);

            EditText MEses = (EditText) findViewById(R.id.ME22Session);
            String MESES=MEses.getText().toString();


            EditText MEone = (EditText) findViewById(R.id.ME2203read);
            EditText MEtwo = (EditText) findViewById(R.id.MEMath2207read);
            EditText MEthree = (EditText) findViewById(R.id.MEHum2207read);
            EditText MEfour = (EditText) findViewById(R.id.ME3103read);
            EditText MEfive = (EditText) findViewById(R.id.MEEEE2285read);
            EditText MEsix = (EditText) findViewById(R.id.ME2204read);
            EditText MEseven = (EditText) findViewById(R.id.ME2210read);
            EditText MEeight = (EditText) findViewById(R.id.ME3100read);
            EditText MEnine = (EditText) findViewById(R.id.MEEEE2286read);
            ...
            Intent intent = new Intent(METwoTwo.this, GpaME22.class);
            intent.putExtra(strMarkME22, pass);
