...
public class CSEOneOne extends AppCompatActivity {

    public static String strMarkCSE11;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cseone_one);
    }

    public void CSE11(View v) {
        try {

            EditText CSEzero = (EditText) findViewById(R.id.CSE11IDread);

            EditText CSEses = (EditText) findViewById(R.id.CSE11Session);
            String CSESES = CSEses.getText().toString();


            EditText CSEone = (EditText) findViewById(R.id.CSEHum1107read);
            EditText CSEtwo = (EditText) findViewById(R.id.CSEHum1108read);
            EditText CSEthree = (EditText) findViewById(R.id.CSEMath1115read);
            EditText CSEfour = (EditText) findViewById(R.id.CSEPhy1115read);
            EditText CSEfive = (EditText) findViewById(R.id.CSEPhy1116read);
            EditText CSEsix = (EditText) findViewById(R.id.CSEChem1115read);
            EditText CSEseven = (EditText) findViewById(R.id.CSE1101read);
            EditText CSEeight = (EditText) findViewById(R.id.CSE1102read);
            EditText CSEnine = (EditText) findViewById(R.id.CSE1108read);
            ...
            double res = gradeCheck(CSEONE) * 3.0 + gradeCheck(CSETWO) * 1.5 +
                    gradeCheck(CSETHREE) * 3.0 + gradeCheck(CSEFOUR) * 3.0 +
                    gradeCheck(CSEFIVE) * 0.75 + gradeCheck(CSESIX) * 3.0 +
                    gradeCheck(CSESEVEN) * 3 + gradeCheck(CSEEIGHT) * 1.5 +
            ...
            Intent intent = new Intent(CSEOneOne.this, GpaCSE11.class);
            intent.putExtra(strMarkCSE11, pass);
