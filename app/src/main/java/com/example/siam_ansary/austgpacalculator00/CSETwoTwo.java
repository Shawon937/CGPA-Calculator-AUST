...
public class CSETwoTwo extends AppCompatActivity {

    public static String strMarkCSE22;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_csetwo_two);
    }

    public void CSE22(View v) {
        try {

            EditText CSEzero = (EditText) findViewById(R.id.CSE22IDread);

            EditText CSEses = (EditText) findViewById(R.id.CSE22Session);
            String CSESES = CSEses.getText().toString();


            EditText CSEone = (EditText) findViewById(R.id.CSEMath2203read);
            EditText CSEtwo = (EditText) findViewById(R.id.CSE2200read);
            EditText CSEthree = (EditText) findViewById(R.id.CSE2201read);
            EditText CSEfour = (EditText) findViewById(R.id.CSE2202read);
            EditText CSEfive = (EditText) findViewById(R.id.CSE2207read);
            EditText CSEsix = (EditText) findViewById(R.id.CSE2208read);
            EditText CSEseven = (EditText) findViewById(R.id.CSE2209read);
            EditText CSEeight = (EditText) findViewById(R.id.CSE2210read);
            EditText CSEnine = (EditText) findViewById(R.id.CSE2213read);
            EditText CSEten = (EditText) findViewById(R.id.CSE2214read);
            ...
            double res = gradeCheck(CSEONE) * 3.0 + gradeCheck(CSETWO) * 0.75 +
                    gradeCheck(CSETHREE) * 3.0 + gradeCheck(CSEFOUR) * 0.75 +
                    gradeCheck(CSEFIVE) * 3.0 + gradeCheck(CSESIX) * 1.5 +
                    gradeCheck(CSESEVEN) * 3.0 + gradeCheck(CSEEIGHT) * 0.75 +
                    gradeCheck(CSENINE) * 3.0 + gradeCheck(CSETEN) * 1.5;
            ...
            Intent intent = new Intent(CSETwoTwo.this, GpaCSE22.class);
            intent.putExtra(strMarkCSE22, pass);
