...
public class TEXThreeOne extends AppCompatActivity {

    public static String strMarkTEX31;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_texthree_one);
    }

    public void TEX31(View v) {
        try {

            EditText TEXzero = (EditText) findViewById(R.id.TEX31IDread);

            EditText TEXses = (EditText) findViewById(R.id.TEX31Session);
            String TEXSES=TEXses.getText().toString();


            EditText TEXone = (EditText) findViewById(R.id.TEX303read);
            EditText TEXtwo = (EditText) findViewById(R.id.TEX304read);
            EditText TEXthree = (EditText) findViewById(R.id.TEX305read);
            EditText TEXfour = (EditText) findViewById(R.id.TEX306read);
            EditText TEXfive = (EditText) findViewById(R.id.TEX311read);
            EditText TEXsix = (EditText) findViewById(R.id.TEX312read);
            EditText TEXseven = (EditText) findViewById(R.id.TEX313read);
            EditText TEXeight = (EditText) findViewById(R.id.TEX314read);
            EditText TEXnine = (EditText) findViewById(R.id.TEX319read);
            ...
            Intent intent = new Intent(TEXThreeOne.this,GpaTEX31.class);
            intent.putExtra(strMarkTEX31, pass);
