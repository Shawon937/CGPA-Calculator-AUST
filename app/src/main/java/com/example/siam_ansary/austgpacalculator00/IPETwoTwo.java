...
public class IPETwoTwo extends AppCompatActivity {

    public static String strMarkIPE22;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ipetwo_two);
    }

    public void IPE22(View v) {
        try {

            EditText IPEzero = (EditText) findViewById(R.id.IPE22IDread);

            EditText IPEses = (EditText) findViewById(R.id.IPE22Session);
            String IPESES=IPEses.getText().toString();


            EditText IPEone = (EditText) findViewById(R.id.IPEME2201read);
            EditText IPEtwo = (EditText) findViewById(R.id.IPEME2203read);
            EditText IPEthree = (EditText) findViewById(R.id.IPEEEE2285read);
            EditText IPEfour = (EditText) findViewById(R.id.IPEMath2207read);
            EditText IPEfive = (EditText) findViewById(R.id.IPEHum2207read);
            EditText IPEsix = (EditText) findViewById(R.id.IPEME2202read);
            EditText IPEseven = (EditText) findViewById(R.id.IPEME2204read);
            EditText IPEeight = (EditText) findViewById(R.id.IPEME2210read);
            EditText IPEnine = (EditText) findViewById(R.id.IPEEEE2286read);
            ...
            double res = gradeCheck(IPEONE) * 3.0 + gradeCheck(IPETWO) * 3.0 +
                    ...
                    gradeCheck(IPEFIVE) * 3.0 + gradeCheck(IPESIX) * 0.75 +
            ...
            Intent intent = new Intent(IPETwoTwo.this, GpaIPE22.class);
            intent.putExtra(strMarkIPE22, pass);
