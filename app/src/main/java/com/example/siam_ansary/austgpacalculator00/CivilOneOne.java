...
public class CivilOneOne extends AppCompatActivity {

    public static String strMarkCivil11;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_civil_one_one);
    }

    public void Civil11(View v) {
        try {

            EditText Civilzero = (EditText) findViewById(R.id.Civil11IDread);

            EditText Civilses = (EditText) findViewById(R.id.Civil11Session);
            String CivilSES=Civilses.getText().toString();


            EditText Civilone = (EditText) findViewById(R.id.CivilPhy101read);
            EditText Civiltwo = (EditText) findViewById(R.id.CivilChem101read);
            EditText Civilthree = (EditText) findViewById(R.id.CivilCE103read);
            EditText Civilfour = (EditText) findViewById(R.id.CivilEEE1131read);
            EditText Civilfive = (EditText) findViewById(R.id.CivilMath101read);
            EditText Civilsix = (EditText) findViewById(R.id.CivilCE100read);
            EditText Civilseven = (EditText) findViewById(R.id.CivilChem102read);
            EditText Civileight = (EditText) findViewById(R.id.CivilEEE1132read);
            ...
            Intent intent = new Intent(CivilOneOne.this, GpaCivil11.class);
            intent.putExtra(strMarkCivil11, pass);
