...
public class IPEThreeTwo extends AppCompatActivity {

    public static String strMarkIPE32;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ipethree_two);
    }

    public void IPE32(View v) {
        try {

            EditText IPEzero = (EditText) findViewById(R.id.IPE32IDread);

            EditText IPEses = (EditText) findViewById(R.id.IPE32Session);
            String IPESES=IPEses.getText().toString();


            EditText IPEone = (EditText) findViewById(R.id.IPE3201read);
            EditText IPEtwo = (EditText) findViewById(R.id.IPE3203read);
            EditText IPEthree = (EditText) findViewById(R.id.IPE3205read);
            EditText IPEfour = (EditText) findViewById(R.id.IPE3207read);
            EditText IPEfive = (EditText) findViewById(R.id.IPE3209read);
            EditText IPEsix = (EditText) findViewById(R.id.IPE3202read);
            EditText IPEseven = (EditText) findViewById(R.id.IPE3204read);
            EditText IPEeight = (EditText) findViewById(R.id.IPE3210read);
            ...
            Intent intent = new Intent(IPEThreeTwo.this, GpaIPE32.class);
            intent.putExtra(strMarkIPE32, pass);
