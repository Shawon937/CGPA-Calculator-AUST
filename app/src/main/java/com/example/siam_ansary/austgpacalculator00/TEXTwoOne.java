...
public class TEXTwoOne extends AppCompatActivity {

    public static String strMarkTEX21;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_textwo_one);
    }

    public void TEX21(View v) {
        try {

            EditText TEXzero = (EditText) findViewById(R.id.TEX21IDread);

            EditText TEXses = (EditText) findViewById(R.id.TEX21Session);
            String TEXSES=TEXses.getText().toString();


            EditText TEXone = (EditText) findViewById(R.id.TEX201read);
            EditText TEXtwo = (EditText) findViewById(R.id.TEX203read);
            EditText TEXthree = (EditText) findViewById(R.id.TEX204read);
            EditText TEXfour = (EditText) findViewById(R.id.TEX205read);
            EditText TEXfive = (EditText) findViewById(R.id.TEX206read);
            EditText TEXsix = (EditText) findViewById(R.id.TEXME201read);
            EditText TEXseven = (EditText) findViewById(R.id.TEXMath205read);
            EditText TEXeight = (EditText) findViewById(R.id.TEXCSE2146read);
            ...
            double res = gradeCheck(TEXONE) * 3.0 + gradeCheck(TEXTWO) * 4.0 +
                    gradeCheck(TEXTHREE) * 1.5 + gradeCheck(TEXFOUR) * 4.0 +
            ...
            Intent intent = new Intent(TEXTwoOne.this,GpaTEX21.class);
            intent.putExtra(strMarkTEX21, pass);
