...
public class METhreeTwo extends AppCompatActivity {

    public static String strMarkME32;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_methree_two);
    }

    public void ME32(View v) {
        try {

            EditText MEzero = (EditText) findViewById(R.id.ME32IDread);

            EditText MEses = (EditText) findViewById(R.id.ME32Session);
            String MESES=MEses.getText().toString();


            EditText MEone = (EditText) findViewById(R.id.ME3201read);
            EditText MEtwo = (EditText) findViewById(R.id.ME3203read);
            EditText MEthree = (EditText) findViewById(R.id.MEIPE3231read);
            EditText MEfour = (EditText) findViewById(R.id.ME3205read);
            EditText MEfive = (EditText) findViewById(R.id.MEIPE3205read);
            EditText MEsix = (EditText) findViewById(R.id.ME3202read);
            EditText MEseven = (EditText) findViewById(R.id.ME3204read);
            EditText MEeight = (EditText) findViewById(R.id.ME3206read);
            ...
            Intent intent = new Intent(METhreeTwo.this, GpaME32.class);
            intent.putExtra(strMarkME32, pass);
